                                ...
                                <div class="col-12">
                                    <div class="invoice-title">
                                        <h4 class="float-end font-size-16"><strong>Invoice No #
                                                {{ $invoice->invoice_no }}</strong>
                                        </h4>
                                        <h3>
                                            <img src="{{ asset('backend/assets/images/logo-sm.png') }}" alt="logo"
                                                height="24" />Tafisa Inventory Systeam
                                        </h3>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        <div class="col-6 mt-4">
                                            <address>
                                                <strong>Tafisa Inventory Systeam:</strong><br>
                                                Kigamboni Dar Es Salaam<br>
                                                toscarjnr@gmail.com
                                            </address>
                                        </div>
                                                ...
                                                <table class="table">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <td class="text-center"><strong>Adress</strong>
